...
yystate(47, [10|Ics], Line, Tlen, _, _) ->
    yystate(47, Ics, Line+1, Tlen+1, 7, Tlen);
yystate(47, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(47, Ics, Line, Tlen+1, 7, Tlen);
yystate(47, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 32 ->
    yystate(47, Ics, Line, Tlen+1, 7, Tlen);
yystate(47, Ics, Line, Tlen, _, _) ->
    {7,Tlen,Ics,Line,47};
yystate(46, [42|Ics], Line, Tlen, Action, Alen) ->
...
yystate(46, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 41 ->
    yystate(46, Ics, Line, Tlen+1, Action, Alen);
yystate(46, [C|Ics], Line, Tlen, Action, Alen) when C >= 43 ->
    yystate(46, Ics, Line, Tlen+1, Action, Alen);
...
yystate(43, [91|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [62|Ics], Line, Tlen, Action, Alen) ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
...
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 32 ->
    yystate(47, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 40, C =< 42 ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 49, C =< 57 ->
    yystate(49, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 58, C =< 60 ->
    yystate(24, Ics, Line, Tlen+1, Action, Alen);
...
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 102, C =< 104 ->
    yystate(20, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 106, C =< 113 ->
    yystate(20, Ics, Line, Tlen+1, Action, Alen);
yystate(43, [C|Ics], Line, Tlen, Action, Alen) when C >= 116, C =< 118 ->
    yystate(20, Ics, Line, Tlen+1, Action, Alen);
...
yystate(34, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(46, Ics, Line, Tlen+1, Action, Alen);
yystate(34, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 46 ->
    yystate(46, Ics, Line, Tlen+1, Action, Alen);
yystate(34, [C|Ics], Line, Tlen, Action, Alen) when C >= 48 ->
    yystate(46, Ics, Line, Tlen+1, Action, Alen);
...
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 11 ->
    yystate(26, Ics, Line, Tlen+1, 8, Tlen);
...
yystate(11, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 36 ->
    yystate(11, Ics, Line, Tlen+1, 7, Tlen);
yystate(11, [C|Ics], Line, Tlen, _, _) when C >= 38 ->
    yystate(11, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 70 ->
    yystate(10, Ics, Line, Tlen+1, 12, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 102 ->
    yystate(10, Ics, Line, Tlen+1, 12, Tlen);
